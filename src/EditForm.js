...
class EditForm extends Component {
   ...
   <Link to="/"><RaisedButton label="Return to Contacts"></RaisedButton></Link>
    <form className="form" onSubmit={this.props.handleEditSubmit}>
        <div>
        <TextField type="text" defaultValue={this.props.contactToEdit.first} name="firstName" id="first" hintText="eg. George" floatingLabelText="First Name" /><br/>
    <TextField type="text" defaultValue={this.props.contactToEdit.last} name="lastName" id="last" hintText="eg. Freeman" floatingLabelText="Last Name" /><br/>
    <TextField type="text" defaultValue={this.props.contactToEdit.birth} name="birthday" id="birth" hintText="eg. November 10, 1959" floatingLabelText="Date of Birth" /><br/>
    <TextField type="text" defaultValue={this.props.contactToEdit.home} name="homePhone" id="home" hintText="eg. (555) 881-3948" floatingLabelText="Home Phone" /><br/>
    <TextField type="text" defaultValue={this.props.contactToEdit.cell} name="cellPhone" id="cell" hintText="eg. (555) 940-2233" floatingLabelText="Cell Phone" /><br/>
    <TextField type="text" defaultValue={this.props.contactToEdit.mail} name="email" id="newEmail" hintText="eg. george_f@gmail.com" floatingLabelText="Email"/><br/>
    <TextField type="text" defaultValue={this.props.contactToEdit.address} name="address" id="newAddress" hintText="eg. 435 Street Avenue" floatingLabelText="Address"/>
